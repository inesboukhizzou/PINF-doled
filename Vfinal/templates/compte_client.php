...
<div class="pts-fidelite">
        <div class="progress-bar-fill-text">Vous avez  <?php echo $users[0]['points_fidelite']; ?> points</div>
        <div class="multi-step-progress-bar">
        
            <div class="progress-bar-fill" style="width: <?php echo min(100, ($users[0]['points_fidelite'] / 10000) * 100); ?>%;">
            
            </div>
            <!-- Marqueurs pour chaque jauge -->
        
            <div class="progress-step" data-step="200" style="left: <?php echo (200 / 10000) * 100; ?>%"></div><
            <div class="progress-step" data-step="1000" style="left: <?php echo (1000 / 10000) * 100; ?>%"></div>
    ...
    <div class="coordonnees-client-conteneur">
        <div class="coordonnees-client">
            ...
            <div id="personal-data-view">
                ...
                <span id="nom-view"><?php echo htmlspecialchars($users[0]['nom']); ?></span>
                </p>
                <p class="coordonnees-client-label"><label class="sous-titre">Prénom</label><br><br>
                <span id="prenom-view"><?php echo htmlspecialchars($users[0]['prenom']); ?></span>
                </p>
            </div>
            <div id="personal-data-edit-nom" style="display:none;">
                <label class="coordonnees-client-label" for="nom">Nom</label>
                <input class="coordonnees-client-input" type="text" id="nom-edit" value="<?php echo htmlspecialchars($users[0]['nom']); ?>">
                <label class="coordonnees-client-label" for="prenom">Prénom</label>
                <input class="coordonnees-client-input" type="text" id="prenom-edit" value="<?php echo htmlspecialchars($users[0]['prenom']); ?>">
        ...
        <div class="coordonnees-client">
            ...
            <div id="personal-data-view">
                <p class="coordonnees-client-label"><label class="sous-titre">Adresse e-mail</label> <br><br>
                    <span id="mail-view"><?php echo htmlspecialchars($users[0]['mail']); ?></span>
                </p>
            </div>
            <div id="personal-data-edit-mail" style="display:none;">
                ...
                <input class="coordonnees-client-input" type="text" id="mail-edit" value="<?php echo htmlspecialchars($users[0]['mail']); ?>">
        ...
        <div class="coordonnees-client">
            ...
            <div id="personal-data-view">
                <p class="coordonnees-client-label"><label class="sous-titre">Numéro de téléphone</label> <br><br>
                    <span id="phone-view"><?php echo htmlspecialchars($users[0]['num_telephone']); ?></span>
                </p>
            </div>
            <div id="personal-data-edit-telephone" style="display:none;">
                ...
                <input class="coordonnees-client-input" type="text" id="phone-edit" value="<?php echo htmlspecialchars($users[0]['num_telephone']); ?>">
                <button class="btn-save telephone" id="btn-save-telephone" name="action" value="modifierPhone">Sauvegarder</button>
            </div>
        </div>
        <div class="coordonnees-client">
            <div class="section-titre">
            ...
            <div id="personal-data-view">
                <p class="coordonnees-client-label"><label class="sous-titre">Adresse </label> <br><br>
                    <span id="adresse-view"><?php echo htmlspecialchars($users[0]['adresse']); ?></span>
                </p>
            </div>
            <div id="personal-data-edit-adresse" style="display:none;">
                <label class="coordonnees-client-label" for="adresse">Adresse</label>
                <input class="coordonnees-client-input" type="text" id="adresse-edit" value="<?php echo htmlspecialchars($users[0]['adresse']); ?>">
                <button class="btn-save adresse" name="action" id="btn-save-adresse" value="modifierAdreses">Sauvegarder</button>
            </div>
        </div>
    </div>
